package javaPackage.coding_test_book_baekjoon.A57_;
/*
...
public class A57_Bus_1916 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(ArrayList<Node> i: list){
            Collections.sort(i);  // 출발 지점과 도착 지점이 같을 경우를 가까운 거리로 정렬하고
                                    // if(distance[nowNode.target]>nowNode.val) continue; 코드를 통해 시간 초과 해소
        }
    ...
    public static int dijkstra(int start, int end){
        ...
        while(!pq.isEmpty()){
            ...
            if(distance[nowNode.target]>nowNode.val) continue;
